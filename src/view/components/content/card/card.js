...
export const card = (image, title, year = null, imdbID = null, btnText = "Add to card") => {
  
  return (
    `<section class="card-movie">
      <div class="card-movie-image">
        <img src="${image === "N/A" ? "./assets/no-image.png" : image}" />
        <div class="card-movie-fave" id="addFaveMovie">
      ...
      ${year && "<p>" + year + "</p>"}
      ${button(btnText, "btn-outline-red")}
    </section>`
  )
};